...
#
# Generated by export_simulation on Sat Nov 28 08:14:07 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './FlipD_0.sh' script.

./FlipD_0.sh -reset_run
...
./FlipD_0.sh -noclean_files

For more information on the script, please type './FlipD_0.sh -help'.
